...
func NewKeeper(
	...
	keeper := &Keeper{
		...
		PayoutVerificationQueue: collections.NewMap[sdk.AccAddress, collections.NoValue](builder, types.VaultStartQueuePrefix, types.VaultStartQueueName, sdk.AccAddressKey, collections.NoValue{}),
		PayoutTimeoutQueue:      collections.NewMap[collections.Pair[uint64, sdk.AccAddress], collections.NoValue](builder, types.VaultEndQueuePrefix, types.VaultEndQueueName, endKeyCodec, collections.NoValue{}),
