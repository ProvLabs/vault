...
func NewRootCmd() *cobra.Command {
	...
	initRootCmd(rootCmd, clientCtx.TxConfig, moduleBasicManager, clientCtx)
...
// ProvideClientContext constructs and returns a new Cosmos SDK client context.
...
// ProvideKeyring returns a new keyring configured for use in the CLI.
