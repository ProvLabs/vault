...
func (*EventBridgeToggled) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef0bb8c93781ed58, []int{22}
}
...
func (*EventBridgeMintShares) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef0bb8c93781ed58, []int{23}
}
...
func (*EventBridgeBurnShares) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef0bb8c93781ed58, []int{24}
}
...
func init() {
	...
	proto.RegisterType((*EventBridgeAddressSet)(nil), "vault.v1.EventBridgeAddressSet")
	proto.RegisterType((*EventBridgeToggled)(nil), "vault.v1.EventBridgeToggled")
	proto.RegisterType((*EventBridgeMintShares)(nil), "vault.v1.EventBridgeMintShares")
	proto.RegisterType((*EventBridgeBurnShares)(nil), "vault.v1.EventBridgeBurnShares")
}
...
var fileDescriptor_ef0bb8c93781ed58 = []byte{
	...
	,
}
