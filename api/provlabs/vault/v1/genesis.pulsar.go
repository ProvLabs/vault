...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.AumFeeAddress) != 0 {
		value := protoreflect.ValueOfBytes(x.AumFeeAddress)
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 5:
				...
				x.AumFeeAddress = append(x.AumFeeAddress[:0], dAtA[iNdEx:postIndex]...)
				if x.AumFeeAddress == nil {
					x.AumFeeAddress = []byte{}
				}
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
func (x *GenesisState) GetAumFeeAddress() []byte {
	if x != nil {
...
var file_provlabs_vault_v1_genesis_proto_rawDesc = []byte{
	...
	0x00, 0x52, 0x07, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0x99, 0x03, 0x0a, 0x0c, 0x47,
	...
	0x51, 0x75, 0x65, 0x75, 0x65, 0x12, 0x3f, 0x0a, 0x0f, 0x61, 0x75, 0x6d, 0x5f, 0x66, 0x65, 0x65,
	0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x17,
	0xd2, 0xb4, 0x2d, 0x13, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x42, 0x79, 0x74, 0x65, 0x73, 0x52, 0x0d, 0x61, 0x75, 0x6d, 0x46, 0x65, 0x65, 0x41,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0xc4, 0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x70,
