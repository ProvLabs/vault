...
func (m *VaultAccount) GetAdvanceRate() string {
	if m != nil {
		return m.AdvanceRate
	}
	return ""
}
...
func (m *VaultNAV) GetVolume() string {
	if m != nil {
		return m.Volume
	}
	return ""
...
func (m *VaultNAV) GetUpdatedBlockHeight() uint64 {
	if m != nil {
...
var fileDescriptor_2e0d78aae3177bea = []byte{
	...
	,
}
...
func (m *VaultAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.AdvanceRate) > 0 {
		i -= len(m.AdvanceRate)
		copy(dAtA[i:], m.AdvanceRate)
		i = encodeVarintVault(dAtA, i, uint64(len(m.AdvanceRate)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xea
...
func (m *VaultNAV) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Volume) > 0 {
		...
		i = encodeVarintVault(dAtA, i, uint64(len(m.Volume)))
		i--
		dAtA[i] = 0x12
	}
	{
...
func (m *VaultAccount) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AdvanceRate", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AdvanceRate = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
