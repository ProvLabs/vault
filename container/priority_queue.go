...
var PriorityQueueKey = collections.NewPair[uint64, sdk.AccAddress](
...
func (q PriorityQueue) Enqueue(ctx context.Context, itemAddr sdk.AccAddress, priority int64) error {
	return q.Set(ctx, collections.Join(uint64(priority), itemAddr))
}

// Dequeue removes an item from the queue.
func (q PriorityQueue) Dequeue(ctx context.Context, itemAddr sdk.AccAddress, priority int64) error {
	return q.Remove(ctx, collections.Join(uint64(priority), itemAddr))
}
...
func (q PriorityQueue) WalkDue(ctx context.Context, maxPriority int64, fn func(priority uint64, itemAddr sdk.AccAddress) (stop bool, err error)) error {
