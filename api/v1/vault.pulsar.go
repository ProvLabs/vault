...
var (
	...
	fd_VaultAccount_swaps_enabled         protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_VaultAccount_swaps_enabled = md_VaultAccount.Fields().ByName("swaps_enabled")
}
...
func (x *fastReflection_VaultAccount) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.SwapsEnabled != false {
		...
		if !f(fd_VaultAccount_swaps_enabled, value) {
			return
		}
	}
}
...
func (x *fastReflection_VaultAccount) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "vault.v1.VaultAccount.swaps_enabled":
...
func (x *fastReflection_VaultAccount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "vault.v1.VaultAccount.swaps_enabled":
		panic(fmt.Errorf("field swaps_enabled of message vault.v1.VaultAccount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vault.v1.VaultAccount"))
		}
...
func (x *VaultAccount) GetSwapsEnabled() bool {
	if x != nil {
...
var file_vault_v1_vault_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x90, 0x03, 0x0a, 0x0c, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x23, 0x0a, 0x0d, 0x73, 0x77, 0x61, 0x70, 0x73, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x73, 0x77, 0x61, 0x70, 0x73, 0x45, 0x6e, 0x61,
	0x62, 0x6c, 0x65, 0x64, 0x22, 0x5a, 0x0a, 0x14, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x49, 0x6e, 0x74,
	0x65, 0x72, 0x65, 0x73, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x21, 0x0a, 0x0c,
