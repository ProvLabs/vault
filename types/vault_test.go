...
func TestVaultAccount_Validate(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "empty fee remainder is valid (treated as zero)",
			vaultAccount: types.VaultAccount{
				BaseAccount:         baseAcc,
				Admin:               validAdmin,
				TotalShares:         sdk.NewInt64Coin(validDenom, 0),
		...
		{
			name: "valid fractional fee remainder",
			vaultAccount: types.VaultAccount{
				BaseAccount:         baseAcc,
				Admin:               validAdmin,
				TotalShares:         sdk.NewInt64Coin(validDenom, 0),
				...
				DesiredInterestRate: validInterest,
				OutstandingAumFee:   sdk.NewInt64Coin("uusd", 0),
				FeeRemainder:        "0.500000000000000000",
			},
			expectedErr: "",
		},
		{
			name: "malformed fee remainder string",
			vaultAccount: types.VaultAccount{
				BaseAccount:         baseAcc,
				Admin:               validAdmin,
				TotalShares:         sdk.NewInt64Coin(validDenom, 0),
				...
				DesiredInterestRate: validInterest,
				OutstandingAumFee:   sdk.NewInt64Coin("uusd", 0),
				FeeRemainder:        invalidInterest,
			},
			expectedErr: "invalid fee remainder",
		},
		{
			name: "negative fee remainder",
			vaultAccount: types.VaultAccount{
				BaseAccount:         baseAcc,
				Admin:               validAdmin,
				TotalShares:         sdk.NewInt64Coin(validDenom, 0),
		...
		},
		{
			...
			vaultAccount: types.VaultAccount{
				...
				CurrentInterestRate: validInterest,
				DesiredInterestRate: validInterest,
				OutstandingAumFee:   sdk.NewInt64Coin("musd", 0),
				FeeRemainder:        "1.500000000000000000",
			},
			expectedErr: "",
		},
		{
			name: "fee remainder at or above one whole unit is invalid when payment denom equals underlying asset",
			vaultAccount: types.VaultAccount{
				BaseAccount:         baseAcc,
				Admin:               validAdmin,
				TotalShares:         sdk.NewInt64Coin(validDenom, 0),
			...
			expectedErr: "fee remainder must carry less than one whole unit",
		},
	}
