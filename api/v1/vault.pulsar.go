...
var (
	...
	fd_PendingWithdrawal_shares        protoreflect.FieldDescriptor
...
func init() {
	...
	fd_PendingWithdrawal_shares = md_PendingWithdrawal.Fields().ByName("shares")
...
func (x *fastReflection_PendingWithdrawal) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Shares != nil {
		...
		if !f(fd_PendingWithdrawal_shares, value) {
			return
		}
	}
	if x.Assets != nil {
...
func (x *fastReflection_PendingWithdrawal) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "vault.v1.PendingWithdrawal.shares":
		return x.Shares != nil
...
func (x *PendingWithdrawal) GetShares() *v1beta11.Coin {
	if x != nil {
		return x.Shares
	}
	return nil
...
var file_vault_v1_vault_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xe8, 0x05, 0x0a, 0x0c, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x44, 0x65, 0x6c, 0x61, 0x79, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x22, 0x97, 0x01, 0x0a,
	...
	0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0xf4, 0x01, 0x0a, 0x11, 0x50, 0x65, 0x6e, 0x64, 0x69,
	0x6e, 0x67, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x12, 0x2e, 0x0a, 0x05,
	...
	0x61, 0x72, 0x65, 0x73, 0x12, 0x37, 0x0a, 0x06, 0x61, 0x73, 0x73, 0x65, 0x74, 0x73, 0x18, 0x04,
...
var file_vault_v1_vault_proto_depIdxs = []int32{
	...
	4, // 2: vault.v1.PendingWithdrawal.shares:type_name -> cosmos.base.v1beta1.Coin
	4, // 3: vault.v1.PendingWithdrawal.assets:type_name -> cosmos.base.v1beta1.Coin
