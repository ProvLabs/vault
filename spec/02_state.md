...
- **AUM Fee State:** `fee_period_start`, `fee_period_timeout`, `outstanding_aum_fee`, and `fee_remainder` (the sub-unit fractional fee, in underlying units, carried across periods so truncation does not discard revenue).
