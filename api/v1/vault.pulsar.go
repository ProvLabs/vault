...
func (x *fastReflection_VaultAccount) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.WithdrawalDelaySeconds != 0 {
			n += 2 + runtime.Sov(uint64(x.WithdrawalDelaySeconds))
		}
		if x.Paused {
			n += 3
		}
...
type VaultAccount struct {
	...
	TotalShares *v1beta11.Coin `protobuf:"bytes,3,opt,name=total_shares,json=totalShares,proto3" json:"total_shares,omitempty"`
	// share_denom is the denomination used to represent shares in the vault (e.g., vault tokens).
	ShareDenom string `protobuf:"bytes,4,opt,name=share_denom,json=shareDenom,proto3" json:"share_denom,omitempty"`
	...
	UnderlyingAsset string `protobuf:"bytes,5,opt,name=underlying_asset,json=underlyingAsset,proto3" json:"underlying_asset,omitempty"`
	...
	CurrentInterestRate string `protobuf:"bytes,8,opt,name=current_interest_rate,json=currentInterestRate,proto3" json:"current_interest_rate,omitempty"`
	...
	DesiredInterestRate string `protobuf:"bytes,9,opt,name=desired_interest_rate,json=desiredInterestRate,proto3" json:"desired_interest_rate,omitempty"`
	...
	MaxInterestRate string `protobuf:"bytes,11,opt,name=max_interest_rate,json=maxInterestRate,proto3" json:"max_interest_rate,omitempty"`
	...
	PeriodTimeout int64 `protobuf:"varint,13,opt,name=period_timeout,json=periodTimeout,proto3" json:"period_timeout,omitempty"`
	// swap_in_enabled indicates whether users are allowed to deposit into the vault.
	SwapInEnabled bool `protobuf:"varint,14,opt,name=swap_in_enabled,json=swapInEnabled,proto3" json:"swap_in_enabled,omitempty"`
	// swap_out_enabled indicates whether users are allowed to withdraw from the vault.
	SwapOutEnabled bool `protobuf:"varint,15,opt,name=swap_out_enabled,json=swapOutEnabled,proto3" json:"swap_out_enabled,omitempty"`
	...
	WithdrawalDelaySeconds uint64 `protobuf:"varint,16,opt,name=withdrawal_delay_seconds,json=withdrawalDelaySeconds,proto3" json:"withdrawal_delay_seconds,omitempty"`
	...
	PausedBalance *v1beta11.Coin `protobuf:"bytes,18,opt,name=paused_balance,json=pausedBalance,proto3" json:"paused_balance,omitempty"`
	// paused_reason is a human-readable string explaining why the vault was paused, particularly for automatic pauses.
	PausedReason string `protobuf:"bytes,19,opt,name=paused_reason,json=pausedReason,proto3" json:"paused_reason,omitempty"`
	...
	BridgeAddress string `protobuf:"bytes,20,opt,name=bridge_address,json=bridgeAddress,proto3" json:"bridge_address,omitempty"`
	...
	BridgeEnabled bool `protobuf:"varint,21,opt,name=bridge_enabled,json=bridgeEnabled,proto3" json:"bridge_enabled,omitempty"`
}
...
var file_vault_v1_vault_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x99, 0x08, 0x0a, 0x0c, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x0c, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x18, 0x03, 0x20,
	...
	,
	...
	,
	...
	0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0xdb, 0x01, 0x0a, 0x0e, 0x50, 0x65, 0x6e, 0x64,
	0x69, 0x6e, 0x67, 0x53, 0x77, 0x61, 0x70, 0x4f, 0x75, 0x74, 0x12, 0x2e, 0x0a, 0x05, 0x6f, 0x77,
	0x6e, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x18, 0xd2, 0xb4, 0x2d, 0x14, 0x63,
	0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x53, 0x74, 0x72,
	0x69, 0x6e, 0x67, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x12, 0x3d, 0x0a, 0x0d, 0x76, 0x61,
	...
	0x65, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x65, 0x64, 0x65, 0x65, 0x6d, 0x5f, 0x64, 0x65, 0x6e,
	0x6f, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x72, 0x65, 0x64, 0x65, 0x65, 0x6d,
	0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x42, 0x8b, 0x01, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x61,
