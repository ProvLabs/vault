...
func (*EventSwapOutRequested) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef0bb8c93781ed58, []int{15}
}
...
func (m *EventSwapOutRequested) GetAssets() types.Coin {
	if m != nil {
		return m.Assets
	}
	return types.Coin{}
...
func (m *EventWithdrawalCompleted) Reset()         { *m = EventWithdrawalCompleted{} }
func (m *EventWithdrawalCompleted) String() string { return proto.CompactTextString(m) }
func (*EventWithdrawalCompleted) ProtoMessage()    {}
func (*EventWithdrawalCompleted) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef0bb8c93781ed58, []int{16}
}
func (m *EventWithdrawalCompleted) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventWithdrawalCompleted) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventWithdrawalCompleted.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventWithdrawalCompleted) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventWithdrawalCompleted.Merge(m, src)
}
func (m *EventWithdrawalCompleted) XXX_Size() int {
	return m.Size()
}
func (m *EventWithdrawalCompleted) XXX_DiscardUnknown() {
	xxx_messageInfo_EventWithdrawalCompleted.DiscardUnknown(m)
}

var xxx_messageInfo_EventWithdrawalCompleted proto.InternalMessageInfo

func (m *EventWithdrawalCompleted) GetVaultAddress() string {
	if m != nil {
		return m.VaultAddress
	}
	return ""
...
func (m *EventWithdrawalCompleted) GetOwner() string {
	if m != nil {
		return m.Owner
	}
	return ""
...
func (m *EventWithdrawalCompleted) GetAssets() types.Coin {
	if m != nil {
		return m.Assets
	}
	return types.Coin{}
...
func (m *EventWithdrawalCompleted) GetRequestId() uint64 {
	if m != nil {
		return m.RequestId
	}
	return 0
...
func (m *EventWithdrawalRefunded) Reset()         { *m = EventWithdrawalRefunded{} }
func (m *EventWithdrawalRefunded) String() string { return proto.CompactTextString(m) }
func (*EventWithdrawalRefunded) ProtoMessage()    {}
func (*EventWithdrawalRefunded) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef0bb8c93781ed58, []int{17}
}
func (m *EventWithdrawalRefunded) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventWithdrawalRefunded) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventWithdrawalRefunded.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventWithdrawalRefunded) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventWithdrawalRefunded.Merge(m, src)
}
func (m *EventWithdrawalRefunded) XXX_Size() int {
	return m.Size()
}
func (m *EventWithdrawalRefunded) XXX_DiscardUnknown() {
	xxx_messageInfo_EventWithdrawalRefunded.DiscardUnknown(m)
}

var xxx_messageInfo_EventWithdrawalRefunded proto.InternalMessageInfo

func (m *EventWithdrawalRefunded) GetVaultAddress() string {
	if m != nil {
		return m.VaultAddress
	}
	return ""
...
func (m *EventWithdrawalRefunded) GetOwner() string {
	if m != nil {
		return m.Owner
	}
	return ""
...
func (m *EventWithdrawalRefunded) GetShares() types.Coin {
	if m != nil {
		return m.Shares
	}
	return types.Coin{}
...
func (m *EventWithdrawalRefunded) GetRequestId() uint64 {
	if m != nil {
		return m.RequestId
	}
	return 0
...
func (m *EventWithdrawalRefunded) GetReason() string {
	if m != nil {
		return m.Reason
	}
	return ""
...
func (m *EventWithdrawalAccelerated) Reset()         { *m = EventWithdrawalAccelerated{} }
func (m *EventWithdrawalAccelerated) String() string { return proto.CompactTextString(m) }
func (*EventWithdrawalAccelerated) ProtoMessage()    {}
func (*EventWithdrawalAccelerated) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef0bb8c93781ed58, []int{18}
}
func (m *EventWithdrawalAccelerated) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventWithdrawalAccelerated) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventWithdrawalAccelerated.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventWithdrawalAccelerated) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventWithdrawalAccelerated.Merge(m, src)
}
func (m *EventWithdrawalAccelerated) XXX_Size() int {
	return m.Size()
}
func (m *EventWithdrawalAccelerated) XXX_DiscardUnknown() {
	xxx_messageInfo_EventWithdrawalAccelerated.DiscardUnknown(m)
}

var xxx_messageInfo_EventWithdrawalAccelerated proto.InternalMessageInfo

func (m *EventWithdrawalAccelerated) GetVaultAddress() string {
	if m != nil {
		return m.VaultAddress
	}
	return ""
...
func (m *EventWithdrawalAccelerated) GetAdmin() string {
	if m != nil {
		return m.Admin
	}
	return ""
...
func (m *EventWithdrawalAccelerated) GetRequestId() uint64 {
	if m != nil {
		return m.RequestId
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*EventSwapOutRequested)(nil), "vault.v1.EventSwapOutRequested")
	proto.RegisterType((*EventWithdrawalCompleted)(nil), "vault.v1.EventWithdrawalCompleted")
	proto.RegisterType((*EventWithdrawalRefunded)(nil), "vault.v1.EventWithdrawalRefunded")
	proto.RegisterType((*EventWithdrawalAccelerated)(nil), "vault.v1.EventWithdrawalAccelerated")
}
...
var fileDescriptor_ef0bb8c93781ed58 = []byte{
	...
	,
}
...
func (m *EventWithdrawalCompleted) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventWithdrawalCompleted) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventWithdrawalCompleted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventWithdrawalRefunded) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventWithdrawalRefunded) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventWithdrawalRefunded) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventWithdrawalAccelerated) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventWithdrawalAccelerated) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventWithdrawalAccelerated) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventWithdrawalCompleted) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventWithdrawalRefunded) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventWithdrawalAccelerated) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventWithdrawalCompleted) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventWithdrawalCompleted: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventWithdrawalCompleted: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *EventWithdrawalRefunded) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventWithdrawalRefunded: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventWithdrawalRefunded: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *EventWithdrawalAccelerated) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventWithdrawalAccelerated: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventWithdrawalAccelerated: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
