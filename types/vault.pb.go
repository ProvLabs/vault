...
func (m *VaultAccount) GetModel() VaultModel {
	if m != nil {
		return m.Model
	}
...
func (m *VaultAccount) GetCollateralPortfolioAddress() string {
	if m != nil {
...
func (m *VaultAccount) GetYldsWalletAddress() string {
	if m != nil {
...
func (m *VaultAccount) GetOrderBookAddress() string {
	if m != nil {
...
func init() {
	proto.RegisterEnum("provlabs.vault.v1.VaultModel", VaultModel_name, VaultModel_value)
...
var fileDescriptor_2e0d78aae3177bea = []byte{
	...
	,
}
...
func (m *VaultAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OrderBookAddress) > 0 {
		...
		i = encodeVarintVault(dAtA, i, uint64(len(m.OrderBookAddress)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x82
	...
	if len(m.YldsWalletAddress) > 0 {
		...
		i = encodeVarintVault(dAtA, i, uint64(len(m.YldsWalletAddress)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xfa
	...
	if len(m.CollateralPortfolioAddress) > 0 {
		...
		i = encodeVarintVault(dAtA, i, uint64(len(m.CollateralPortfolioAddress)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf2
	...
	if m.Model != 0 {
		i = encodeVarintVault(dAtA, i, uint64(m.Model))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xe8
