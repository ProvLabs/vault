...
var (
	...
	fd_VaultAccount_pause_reason             protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_VaultAccount_pause_reason = md_VaultAccount.Fields().ByName("pause_reason")
}
...
func (x *fastReflection_VaultAccount) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.PauseReason != "" {
		...
		if !f(fd_VaultAccount_pause_reason, value) {
			return
		}
	}
}
...
func (x *fastReflection_VaultAccount) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "vault.v1.VaultAccount.pause_reason":
...
func (x *fastReflection_VaultAccount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "vault.v1.VaultAccount.pause_reason":
		panic(fmt.Errorf("field pause_reason of message vault.v1.VaultAccount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vault.v1.VaultAccount"))
		}
...
func (x *VaultAccount) GetPauseReason() string {
	if x != nil {
		return x.PauseReason
	}
	return ""
...
var file_vault_v1_vault_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xeb, 0x06, 0x0a, 0x0c, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x61, 0x75, 0x73, 0x65, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x21, 0x0a, 0x0c,
	0x70, 0x61, 0x75, 0x73, 0x65, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x11, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0b, 0x70, 0x61, 0x75, 0x73, 0x65, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22,
	...
	0x08, 0x88, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0xdb, 0x01, 0x0a, 0x0e, 0x50, 0x65,
	0x6e, 0x64, 0x69, 0x6e, 0x67, 0x53, 0x77, 0x61, 0x70, 0x4f, 0x75, 0x74, 0x12, 0x2e, 0x0a, 0x05,
	...
	0x65, 0x6d, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x42, 0x8b, 0x01, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e,
