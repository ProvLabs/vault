...
type VaultAccount struct {
	...
	*types.BaseAccount `protobuf:"bytes,1,opt,name=base_account,json=baseAccount,proto3,embedded=base_account" json:"base_account,omitempty"`
	...
	// the bank module.
	TechFeeAccrued cosmossdk_io_math.Int `protobuf:"bytes,21,opt,name=tech_fee_accrued,json=techFeeAccrued,proto3,customtype=cosmossdk.io/math.Int" json:"tech_fee_accrued"`
}
...
var fileDescriptor_2e0d78aae3177bea = []byte{
	...
	,
}
...
func (m *VaultAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.TechFeeAccrued.Size()
		i -= size
		if _, err := m.TechFeeAccrued.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *VaultAccount) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TechFeeAccrued", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.TechFeeAccrued.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
