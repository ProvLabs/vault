...
var (
	...
	fd_MsgWithdrawInterestFundsRequest_interest_admin protoreflect.FieldDescriptor
...
func init() {
	...
	fd_MsgWithdrawInterestFundsRequest_interest_admin = md_MsgWithdrawInterestFundsRequest.Fields().ByName("interest_admin")
...
func (x *fastReflection_MsgWithdrawInterestFundsRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.InterestAdmin != "" {
		value := protoreflect.ValueOfString(x.InterestAdmin)
		if !f(fd_MsgWithdrawInterestFundsRequest_interest_admin, value) {
			return
		}
	}
	if x.VaultAddress != "" {
...
func (x *fastReflection_MsgWithdrawInterestFundsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vault.v1.MsgWithdrawInterestFundsRequest.interest_admin":
		return x.InterestAdmin != ""
...
func (x *fastReflection_MsgWithdrawInterestFundsRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "vault.v1.MsgWithdrawInterestFundsRequest.interest_admin":
		x.InterestAdmin = value.Interface().(string)
	case "vault.v1.MsgWithdrawInterestFundsRequest.vault_address":
		x.VaultAddress = value.Interface().(string)
	case "vault.v1.MsgWithdrawInterestFundsRequest.amount":
		x.Amount = value.Message().Interface().(*v1beta1.Coin)
...
func (x *fastReflection_MsgWithdrawInterestFundsRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "vault.v1.MsgWithdrawInterestFundsRequest.amount":
		...
		return protoreflect.ValueOfMessage(x.Amount.ProtoReflect())
	case "vault.v1.MsgWithdrawInterestFundsRequest.interest_admin":
		panic(fmt.Errorf("field interest_admin of message vault.v1.MsgWithdrawInterestFundsRequest is not mutable"))
	case "vault.v1.MsgWithdrawInterestFundsRequest.vault_address":
...
func (x *fastReflection_MsgWithdrawInterestFundsRequest) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.InterestAdmin) > 0 {
			i -= len(x.InterestAdmin)
			copy(dAtA[i:], x.InterestAdmin)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.InterestAdmin)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field InterestAdmin", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.InterestAdmin = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field VaultAddress", wireType)
...
func (x *MsgWithdrawInterestFundsRequest) GetInterestAdmin() string {
	if x != nil {
		return x.InterestAdmin
	}
	return ""
...
var file_vault_v1_tx_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x22, 0x9d, 0x01, 0x0a, 0x15, 0x4d, 0x73, 0x67, 0x54, 0x6f, 0x67, 0x67, 0x6c, 0x65, 0x53,
	0x77, 0x61, 0x70, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x05, 0x61,
	...
	0x61, 0x75, 0x6c, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0c, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	0x12, 0x23, 0x0a, 0x0d, 0x73, 0x77, 0x61, 0x70, 0x73, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x73, 0x77, 0x61, 0x70, 0x73, 0x45, 0x6e,
	0x61, 0x62, 0x6c, 0x65, 0x64, 0x3a, 0x0a, 0x82, 0xe7, 0xb0, 0x2a, 0x05, 0x61, 0x64, 0x6d, 0x69,
	0x6e, 0x22, 0x18, 0x0a, 0x16, 0x4d, 0x73, 0x67, 0x54, 0x6f, 0x67, 0x67, 0x6c, 0x65, 0x53, 0x77,
	0x61, 0x70, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xcb, 0x05, 0x0a, 0x03,
	...
	0x65, 0x73, 0x74, 0x46, 0x75, 0x6e, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x50, 0x0a, 0x0b, 0x54, 0x6f, 0x67, 0x67, 0x6c, 0x65, 0x53, 0x77, 0x61, 0x70, 0x73, 0x12,
	0x1f, 0x2e, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x73, 0x67, 0x54, 0x6f,
	0x67, 0x67, 0x6c, 0x65, 0x53, 0x77, 0x61, 0x70, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x20, 0x2e, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x73, 0x67, 0x54,
	0x6f, 0x67, 0x67, 0x6c, 0x65, 0x53, 0x77, 0x61, 0x70, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
