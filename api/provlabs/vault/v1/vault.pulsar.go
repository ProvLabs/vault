...
var (
	...
	fd_AssetNAV_asset_denom  protoreflect.FieldDescriptor
	fd_AssetNAV_price        protoreflect.FieldDescriptor
	fd_AssetNAV_last_updated protoreflect.FieldDescriptor
)

func init() {
	file_provlabs_vault_v1_vault_proto_init()
	md_AssetNAV = File_provlabs_vault_v1_vault_proto.Messages().ByName("AssetNAV")
	fd_AssetNAV_asset_denom = md_AssetNAV.Fields().ByName("asset_denom")
	fd_AssetNAV_price = md_AssetNAV.Fields().ByName("price")
	fd_AssetNAV_last_updated = md_AssetNAV.Fields().ByName("last_updated")
}
...
func (x *fastReflection_AssetNAV) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.AssetDenom != "" {
		...
		if !f(fd_AssetNAV_asset_denom, value) {
			return
		}
	}
	if x.Price != nil {
	...
	if x.LastUpdated != int64(0) {
		...
		if !f(fd_AssetNAV_last_updated, value) {
			return
		}
	}
}
...
func (x *fastReflection_AssetNAV) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "provlabs.vault.v1.AssetNAV.asset_denom":
		return x.AssetDenom != ""
	case "provlabs.vault.v1.AssetNAV.price":
		return x.Price != nil
	case "provlabs.vault.v1.AssetNAV.last_updated":
...
func (x *fastReflection_AssetNAV) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "provlabs.vault.v1.AssetNAV.asset_denom":
		panic(fmt.Errorf("field asset_denom of message provlabs.vault.v1.AssetNAV is not mutable"))
	case "provlabs.vault.v1.AssetNAV.last_updated":
		panic(fmt.Errorf("field last_updated of message provlabs.vault.v1.AssetNAV is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: provlabs.vault.v1.AssetNAV"))
		}
...
// AssetNAV represents a vault-specific Net Asset Value for a particular asset.
type AssetNAV struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// asset_denom is the denomination of the asset.
	AssetDenom string `protobuf:"bytes,1,opt,name=asset_denom,json=assetDenom,proto3" json:"asset_denom,omitempty"`
	// price is the value of one unit of the asset expressed in the vault's underlying asset.
	Price *v1beta11.Coin `protobuf:"bytes,2,opt,name=price,proto3" json:"price,omitempty"`
	// last_updated is the block time (in Unix seconds) when this NAV was last updated.
...
func (x *AssetNAV) GetAssetDenom() string {
	if x != nil {
		return x.AssetDenom
	}
	return ""
...
func (x *AssetNAV) GetPrice() *v1beta11.Coin {
	if x != nil {
		return x.Price
	}
	return nil
...
func (x *AssetNAV) GetLastUpdated() int64 {
	if x != nil {
...
var file_provlabs_vault_v1_vault_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xe0, 0x09, 0x0a, 0x0c, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x41, 0x63, 0x63,
	...
	0x41, 0x75, 0x6d, 0x46, 0x65, 0x65, 0x22, 0x97, 0x01, 0x0a, 0x0e, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	,
...
var file_provlabs_vault_v1_vault_proto_goTypes = []interface{}{
	...
	(*AssetNAV)(nil),            // 3: provlabs.vault.v1.AssetNAV
...
var file_provlabs_vault_v1_vault_proto_depIdxs = []int32{
	...
	5, // 6: provlabs.vault.v1.AssetNAV.price:type_name -> cosmos.base.v1beta1.Coin
