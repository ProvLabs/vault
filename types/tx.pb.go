...
// MsgAcceptPaymentsRequest is the request message for accepting pending payments from a specific source.
type MsgAcceptPaymentsRequest struct {
	// authority is the address of the vault administrator or asset manager.
	Authority string `protobuf:"bytes,1,opt,name=authority,proto3" json:"authority,omitempty"`
	// vault_address is the bech32 address of the vault.
	VaultAddress string `protobuf:"bytes,2,opt,name=vault_address,json=vaultAddress,proto3" json:"vault_address,omitempty"`
	// source is the address of the payment source (e.g. the issuer).
	Source string `protobuf:"bytes,3,opt,name=source,proto3" json:"source,omitempty"`
}

func (m *MsgAcceptPaymentsRequest) Reset()         { *m = MsgAcceptPaymentsRequest{} }
func (m *MsgAcceptPaymentsRequest) String() string { return proto.CompactTextString(m) }
func (*MsgAcceptPaymentsRequest) ProtoMessage()    {}
func (*MsgAcceptPaymentsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1bb9c8306211b32d, []int{44}
}
func (m *MsgAcceptPaymentsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgAcceptPaymentsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgAcceptPaymentsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgAcceptPaymentsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgAcceptPaymentsRequest.Merge(m, src)
}
func (m *MsgAcceptPaymentsRequest) XXX_Size() int {
	return m.Size()
}
func (m *MsgAcceptPaymentsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgAcceptPaymentsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MsgAcceptPaymentsRequest proto.InternalMessageInfo

func (m *MsgAcceptPaymentsRequest) GetAuthority() string {
	if m != nil {
		return m.Authority
	}
	return ""
...
func (m *MsgAcceptPaymentsRequest) GetVaultAddress() string {
	if m != nil {
		return m.VaultAddress
	}
	return ""
...
func (m *MsgAcceptPaymentsRequest) GetSource() string {
	if m != nil {
		return m.Source
	}
	return ""
...
// MsgAcceptPaymentsResponse is the response message for the AcceptPayments endpoint.
type MsgAcceptPaymentsResponse struct {
	// accepted_payment_ids is a list of payment IDs that were successfully accepted.
	AcceptedPaymentIds []uint64 `protobuf:"varint,1,rep,packed,name=accepted_payment_ids,json=acceptedPaymentIds,proto3" json:"accepted_payment_ids,omitempty"`
}

func (m *MsgAcceptPaymentsResponse) Reset()         { *m = MsgAcceptPaymentsResponse{} }
func (m *MsgAcceptPaymentsResponse) String() string { return proto.CompactTextString(m) }
func (*MsgAcceptPaymentsResponse) ProtoMessage()    {}
func (*MsgAcceptPaymentsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1bb9c8306211b32d, []int{45}
}
func (m *MsgAcceptPaymentsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgAcceptPaymentsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgAcceptPaymentsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgAcceptPaymentsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgAcceptPaymentsResponse.Merge(m, src)
}
func (m *MsgAcceptPaymentsResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgAcceptPaymentsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgAcceptPaymentsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgAcceptPaymentsResponse proto.InternalMessageInfo

func (m *MsgAcceptPaymentsResponse) GetAcceptedPaymentIds() []uint64 {
	if m != nil {
		return m.AcceptedPaymentIds
	}
	return nil
}

// MsgUpdateAssetNAVRequest is the request message for updating the custom NAV for an asset.
type MsgUpdateAssetNAVRequest struct {
	// authority is the address of the vault administrator or asset manager.
	Authority string `protobuf:"bytes,1,opt,name=authority,proto3" json:"authority,omitempty"`
	// vault_address is the bech32 address of the vault.
	VaultAddress string `protobuf:"bytes,2,opt,name=vault_address,json=vaultAddress,proto3" json:"vault_address,omitempty"`
	// asset_denom is the denomination of the asset being priced.
	AssetDenom string `protobuf:"bytes,3,opt,name=asset_denom,json=assetDenom,proto3" json:"asset_denom,omitempty"`
	// asset_price is the new price for the asset, expressed in the vault's underlying asset.
	AssetPrice types1.Coin `protobuf:"bytes,4,opt,name=asset_price,json=assetPrice,proto3" json:"asset_price"`
}
...
func (m *MsgUpdateAssetNAVRequest) GetAssetDenom() string {
	if m != nil {
		return m.AssetDenom
	}
	return ""
...
func (m *MsgUpdateAssetNAVRequest) GetAssetPrice() types1.Coin {
	if m != nil {
		return m.AssetPrice
	}
	return types1.Coin{}
...
// MsgUpdateAssetNAVResponse is the response message for the UpdateAssetNAV endpoint.
...
func init() {
	...
	proto.RegisterType((*MsgAcceptPaymentsRequest)(nil), "provlabs.vault.v1.MsgAcceptPaymentsRequest")
	proto.RegisterType((*MsgAcceptPaymentsResponse)(nil), "provlabs.vault.v1.MsgAcceptPaymentsResponse")
...
var fileDescriptor_1bb9c8306211b32d = []byte{
	...
	,
}
...
func (c *msgClient) AcceptPayments(ctx context.Context, in *MsgAcceptPaymentsRequest, opts ...grpc.CallOption) (*MsgAcceptPaymentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/provlabs.vault.v1.Msg/AcceptPayments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMsgServer) AcceptPayments(ctx context.Context, req *MsgAcceptPaymentsRequest) (*MsgAcceptPaymentsResponse, error) {
...
func _Msg_AcceptPayments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/provlabs.vault.v1.Msg/AcceptPayments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgAcceptPaymentsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgAcceptPaymentsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgAcceptPaymentsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgAcceptPaymentsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgAcceptPaymentsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgAcceptPaymentsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.AcceptedPaymentIds) > 0 {
		dAtA12 := make([]byte, len(m.AcceptedPaymentIds)*10)
		var j11 int
		for _, num := range m.AcceptedPaymentIds {
			for num >= 1<<7 {
...
func (m *MsgUpdateAssetNAVRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.AssetPrice.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MsgAcceptPaymentsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgAcceptPaymentsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.AcceptedPaymentIds) > 0 {
		l = 0
		for _, e := range m.AcceptedPaymentIds {
			l += sovTx(uint64(e))
		}
...
func (m *MsgAcceptPaymentsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgAcceptPaymentsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgAcceptPaymentsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgAcceptPaymentsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgAcceptPaymentsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgAcceptPaymentsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
				...
				m.AcceptedPaymentIds = append(m.AcceptedPaymentIds, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.AcceptedPaymentIds) == 0 {
					m.AcceptedPaymentIds = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field AcceptedPaymentIds", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
...
func (m *MsgUpdateAssetNAVRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := m.AssetPrice.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
