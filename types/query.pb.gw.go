...
var (
	...
	pattern_Query_PendingWithdrawals_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"vault", "v1", "pending_withdrawals"}, "", runtime.AssumeColonVerbOpt(false)))
)
